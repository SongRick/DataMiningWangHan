...
def func_list_version():
    ...
    print(f"列表版本操作执行完成，耗时: {execution_time} 秒")

def func_tuple_version():
    ...
    for _ in range(10000):
        ...
        new_row[3] = 1
        new_tuple = my_tuple[:2] + (tuple(new_row),) + my_tuple[3:]
        my_tuple = new_tuple
    ...
    print(f"元组版本操作执行完成，耗时: {execution_time} 秒")
